...
export default function Footer() {
  return (
    <footer className="mt-24 border-top border-white/15">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://twitter.com" target="_blank" rel="noreferrer" aria-label="Twitter" className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/20 hover:bg-white/50 dark:hover:bg-white/20">
              ...
              <a href="https://www.linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/20 hover:bg-white/50 dark:hover:bg-white/20">
            ...
            <form onSubmit={(e)=>{e.preventDefault(); import("sonner").then(({toast})=>toast.success("Subscribed!"));}} className="mt-4 flex items-center gap-2">
              <input type="email" required placeholder="Your email" className="w-full rounded-xl border border-white/30 bg-transparent px-3 py-2 text-sm outline-none placeholder:opacity-60 focus:border-white/50" />
