  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="container-px mx-auto">
        <nav className="sticky top-4 mt-4 flex items-center justify-between rounded-full border border-white/20 bg-white/70 p-2 pl-4 pr-2 backdrop-blur shadow-sm dark:bg-white/10">
